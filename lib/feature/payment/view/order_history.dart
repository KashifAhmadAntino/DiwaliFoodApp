  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return orderHistoryController.loader.value == true
            ? const Center(child: CircularProgressIndicator())
            : Container(
                padding: const EdgeInsets.symmetric(horizontal: 10),
                child: (orderHistoryController.data.value.data!).length == 0
                    ? Center(
                        child: Text("Please Order from Team E-Counter"),
                      )
                        ...
                        child: Column(
                          ...
                          children: [
                            ListView.builder(
                                ...
                                reverse: true,
                                itemCount:
                                    (orderHistoryController.data.value.data!)
                                        .length,
